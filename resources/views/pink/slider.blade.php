...
<div id="slider-cycle" class="slider cycle no-responsive slider_cycle group" style="height:485px;">
    <ul class="slider">
        ...
        @foreach($sliders as $slider)
            <li>
                <div class="slide-holder" style="background: url({{$slider['img']}}) no-repeat center center" style="height:483px;">
                    <div class="slide-content-holder inner" style="height:483px;">
                        @if($x%2 != 0)
                            <div class="slide-content-holder-content" style="position: absolute; top:60px;right:650px;">
                        @else
                            <div class="slide-content-holder-content" style="position: absolute; top:80px;left:650px;">
                        @endif
